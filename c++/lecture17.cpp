...
class porsche{
    ...
    void display(){
        cout<<this->color<<endl<<this->seat<<endl<<this->engine<<endl<<this->name<<endl<<this->year<<endl<<this->serial<<endl<<this->registration<<endl<<this->company<<endl;
    }
};
string porsche::company="porsche";
